# a virtual pet to care for - "back door version" that shows the exact values of the object's attributes by printing the object when a secret selection, not listed in the menu is entered as the user's choice.
...
class Critter(object):
    ...
    def play(self):
        play_time = int(input("How long do you want to play? Choose between 1-4 (1 = 15min): "))
    ...
    def __str__(self):
        details = "Critter Object\n" + "name: " + self.name + "\nhunger: " + str(self.hunger) + "\nboredom: " +  str(self.boredom) + "\nmood level: " + str(self.mood)
        return details
        print(details)
